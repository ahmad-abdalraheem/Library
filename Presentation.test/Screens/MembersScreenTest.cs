	...
	public class MembersScreenTests
	{
		...
		public void MembersMenu_ShouldDisplayNoMembersMessage_WhenMembersListIsEmpty()
		{
			...
			_testConsole.AddKeySequence([
				ConsoleKey.DownArrow, ConsoleKey.Enter, ConsoleKey.DownArrow, ConsoleKey.DownArrow,
		...
		public void MembersMenu_ShouldAddMemberToList_WhenMembersListIsEmpty()
		{
			...
			_mockMemberService.Setup(ms => ms.Add(It.IsAny<Member>()))
				.Callback((Member member) => _membersList.Add(member)).Returns(true);
			_testConsole.KeyInput.Clear();
		...
		public void MembersMenu_ShouldDisplayMembersAndMoveBetweenMembers()
		{
			...
			_testConsole.KeyInput.Clear();
			_testConsole.AddKeySequence([
				ConsoleKey.DownArrow, ConsoleKey.UpArrow, ConsoleKey.DownArrow, ConsoleKey.Backspace
			]);
		...
		public void MembersMenu_ShouldDeleteSelectedMember_WhenDeleteKeyIsPressed()
		{
			...
			_mockMemberService.Setup(s => s.Get()).Returns(_membersList);
			_mockMemberService.Setup(ms => ms.Delete(It.IsAny<int>()))
				.Callback((int id) => _membersList.RemoveAll(m => m.Id == id));

			_testConsole.KeyInput.Clear();
			_testConsole.AddKeySequence([
				ConsoleKey.DownArrow, ConsoleKey.UpArrow, ConsoleKey.Delete, ConsoleKey.Backspace
			]);
