...
public class UserInteractionTest
{
	...
	public void GetUserSelection_ShouldNotReturnNegative()
	{
		...
		console.AddKeySequence([
			ConsoleKey.DownArrow, ConsoleKey.UpArrow, ConsoleKey.UpArrow, ConsoleKey.UpArrow, ConsoleKey.Enter
		]);
	...
	public void GetUserSelection_ShouldNotReturnOutOfRange()
	{
		TestConsole console = new TestConsole();
		console.AddKeySequence([
			ConsoleKey.DownArrow, ConsoleKey.DownArrow, ConsoleKey.DownArrow, ConsoleKey.DownArrow, ConsoleKey.Enter
		]);
		List<String> options = ["Option 1", "Option 2", "Option 3"];
